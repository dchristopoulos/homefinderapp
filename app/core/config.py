...
DEFAULT_DB_PATH = PROJECT_ROOT / "homefinder.db"


class Settings(BaseSettings):
    model_config = SettingsConfigDict(env_file=".env", extra="ignore")

    app_name: str = "HomeFinder API"
    ...
    register_rate_limit_per_minute: int = 8
    ...
    smtp_username: str = ""
    smtp_password: str = ""
    smtp_from_email: str = "noreply@homefinder.local"
    ...
    def validate_production_settings(self):
        ...
        validate_homefinder_database_url(
            self.database_url,
