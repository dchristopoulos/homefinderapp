...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(OwnerNotFoundError)
    async def owner_not_found_handler(_: Request, __: OwnerNotFoundError) -> JSONResponse:
        return JSONResponse(status_code=400, content={"detail": "Owner not found"})
