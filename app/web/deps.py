...
logger = logging.getLogger("homefinder.web.deps")
...
LISTING_PLACEHOLDER_IMAGE = "/static/listing-placeholder.svg"
...
def listing_image_url(image_url: str | None) -> str:
    if not image_url:
        return LISTING_PLACEHOLDER_IMAGE
    if image_url.startswith("/static/"):
        static_path = STATIC_DIR / image_url.removeprefix("/static/")
        if not static_path.exists():
            return LISTING_PLACEHOLDER_IMAGE
    return image_url


templates.env.globals["listing_image_url"] = listing_image_url
