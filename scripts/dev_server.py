...
def main() -> int:
    parser = argparse.ArgumentParser(description='Run HomeFinder dev server with reliable port fallback.')
    ...
    print(f'Starting HomeFinder on http://{args.host}:{target_port} (reload={args.reload})')
